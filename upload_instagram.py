...
def upload_to_instagram(video_path, caption="", is_story=False):
    ...
    if not user_id:
        print("[instagram] Skipping - no Instagram Business Account connected to this Page")
    ...
    if file_size > 12 * 1024 * 1024:
        print(f"[instagram] File size ({file_size/(1024*1024):.2f} MB) > 12MB. Optimizing with FFmpeg...")
        ...
        try:
            ...
            print(f"[instagram] FFmpeg optimization notice: {comp_err}")
    ...
    try:
        ...
        print("[instagram] Step 3: Waiting for Meta to process container (sleep-based polling)...")
        max_wait = 180
        waited = 0
        pub_res = None

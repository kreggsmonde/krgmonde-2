...
Psychologie & Developpement Personnel

#Shorts #Psychologie #BienEtre #Motivation #IA"""

    
    tags = [
        'Shorts', 'Psychologie', 'Bien-etre', 'Motivation', 'IA', 'Inspiration', 'Developpement Personnel'
    ]
    ...
    if all([os.getenv('THREADS_ACCESS_TOKEN'), os.getenv('THREADS_USER_ID')]):
        ...
        print("="*60)
        try:
            result = upload_to_threads(str(video_file), description)
